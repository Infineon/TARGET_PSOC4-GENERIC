...
#ifndef CY8C4548AZI_S485
    #error "Unexpected target MCU; expected CY8C4548AZI-S485. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
